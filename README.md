...
🔗 **Live App**: https://trusttrip.vercel.app/
🎥 **Demo Video**: https://www.youtube.com/watch?v=your-video-id (Update with actual URL)  
💻 **Source Code**: https://github.com/Anish99594/TrustTrip.git (Update with actual repo)  
...
- 🐦 Twitter: @TrustTrip *(Update actual handle)*  
- 💬 Discord: *(Update actual link)*  
